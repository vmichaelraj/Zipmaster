...
const onFileChange = (event) => {
  if (event.target && event.target?.files?.length > 0) {
    ...
    uploadBox.innerHTML =
      '<div class="file-list-container"><h2>Selected Files:</h2><ul id="file-list"></ul><button id="confirm-upload" class="confirm-button">Confirm</button></div>';
...
const resetuploadBox=()=>{
    uploadBox.innerHTML='<input type="file" hidden id="file-input" multiple/><label for="file-input" class="upload-button">Upload<div class="upload-button-container"><img src="public/icons8-up-90.png" alt="icon" height="24px" /></div></label>';
